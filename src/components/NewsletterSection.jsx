  ...
  return (
    <section className='container mx-auto px-4 sm:px-6 lg:px-8 py-16'>
            ...
            <div className='relative md:px-16 py-16 px-6 md:py-24'>
                ...
                <div className='relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12'>
                    ...
                    <div className='text-white max-w-lg text-center md:text-left'>
                        ...
                        <p className='text-blue-100 text-sm sm:text-base '>Best cooks and best delivery guys all at ypur service. Hot tasty food </p>
        ...
        <style>
            {
                `.clip-path-slant {
                    clip-path: polygon(20% 0%, 200% 0%, 100% 100%, 0% 100%);   
                }`
            }
        </style>
    </section>
